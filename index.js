...
async function run() {
    try {
        ...
        const database = client.db('WP_Gradient');
...
app.get('/', (req, res) => {
    res.send('Running Wp Gradient Server');
});
app.get('/updateex', (req, res) => {
    res.send('Wp Gradient Server update hoiche');
});
...
app.listen(port, () => {
    console.log('wow Wp Gradient Server on port', port);
})